...
public class MessageCode {
    ...
    public static int CONNECTION_READY = 409;
    public static int CLIENT_DISCONNECT = 410;
    public static int CONNECTION_EXCEPTION = 411;
    public static int CONNECTION_LOST = 412;
